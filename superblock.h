...
int write_superblock_with_offsets(const char *folder,u32 block_size,u32 total_blocks,u32 total_inodes,
    const unsigned char *inode_bitmap_128,const unsigned char *data_bitmap_128,u32 root_inode,
