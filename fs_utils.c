...
u32 u32le_read(const unsigned char *p) {    return ((u32)p[0]) | ((u32)p[1] << 8) | ((u32)p[2] << 16) | ((u32)p[3] << 24);}

//Cuántos bloques se ocupa para almacenar inode_table_bytes, redondeando hacia arriba para cubrir el último bloque.
